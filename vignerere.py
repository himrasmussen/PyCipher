...
class VignerereCipher(CryptoBase):
        def __init__(self, *args, **kwargs):
                super(VignerereCipher, self).__init__(*args, **kwargs)
...
if __name__ == "__main__":
        thekey = "longstring"
        encrypt = VignerereCipher(msg="it's a nice day for a walk", key=thekey, mode="encrypt")

        encrypt.excecute()
        print(encrypt.new_msg)

        decrypt = VignerereCipher(msg=encrypt.new_msg, key=thekey, mode="decrypt")
        decrypt.excecute()
